...
@HippoEssentialsGenerated(internalName = "calvinwebsite:account")
@Node(jcrType = "calvinwebsite:account")
public class Account extends HippoCompound {

    public static final String TYPE = "calvinwebsite:type";
    public static final String LINK = "calvinwebsite:link";

    @HippoEssentialsGenerated(internalName = "calvinwebsite:type")
